...
export default {
  ...
  currencyDetail: [
    ...
    { name: "Bahraini Dinar", pos: "before", value: "BHD", geckoId: "bhd" },
    ...
    { name: "New Zealand Dollar", pos: "before", value: "$", geckoId: "nzd" },
